...
export interface SampleImmutableERC1155SoulboundInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface SampleImmutableERC1155Soulbound extends BaseContract {
  connect(runner?: ContractRunner | null): SampleImmutableERC1155Soulbound;
  waitForDeployment(): Promise<this>;

  interface: SampleImmutableERC1155SoulboundInterface;
