...
export interface SampleImmutableERC721SoulboundInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface SampleImmutableERC721Soulbound extends BaseContract {
  connect(runner?: ContractRunner | null): SampleImmutableERC721Soulbound;
  waitForDeployment(): Promise<this>;

  interface: SampleImmutableERC721SoulboundInterface;
