...
export interface SampleImmutableERC1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface SampleImmutableERC1155 extends BaseContract {
  connect(runner?: ContractRunner | null): SampleImmutableERC1155;
  waitForDeployment(): Promise<this>;

  interface: SampleImmutableERC1155Interface;
